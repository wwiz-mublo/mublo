...
use Mublo\Contract\Frame\DomainFrameEditorInterface;
 ...
 * 주입하므로 저장 시 제거한다.
 */
class DomainFrameService implements DomainFrameEditorInterface
{
    ...
    {
        return $this->get($domainId, $part) !== null;
    }
    ...
    {
        return self::publishedParts($themeConfig);
    }
