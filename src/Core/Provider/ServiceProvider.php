...
class ServiceProvider
{
    ...
    public function register(DependencyContainer $container): void
    {
        ...
        $container->singleton(LoginAttemptService::class, function (DependencyContainer $c) {
            $securityConfigPath = MUBLO_ROOT_PATH . '/config/security.php';
            ...
            if (!is_array($securityConfig)) {
                throw new \RuntimeException('Invalid security configuration: config/security.php must return an array.');
            }
