...
HTML;
    ...
    protected function extractTitleConfig(BlockColumn $column): array
    {
        return [
            ...
            'more_text' => $column->getMoreText(),
            'copytext' => $column->getCopytext(),
            'copytext_color' => $column->getCopytextColor(),
            'copytext_position' => $column->getCopytextPosition(),
            'copytext_size_pc' => $column->getCopytextPcSize(),
            'copytext_size_mo' => $column->getCopytextMobileSize(),
        ];
    }
