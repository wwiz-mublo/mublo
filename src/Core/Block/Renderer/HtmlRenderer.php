...
class HtmlRenderer implements RendererInterface
{
    ...
    private function renderSingleMode(BlockColumnView $column, string $skin, array $config, string $css, string $js): string
    {
        $rawHtml = $config['html'] ?? '';
    ...
    private function renderSlideMode(BlockColumnView $column, string $skin, array $config, string $css, string $js): string
    {
