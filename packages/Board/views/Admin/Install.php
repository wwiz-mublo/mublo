 ...
 */
$pending = $pending ?? [];
$pageTitle = $pageTitle ?? ($title ?? '게시판 패키지 설치');
?>
...
<div class="card">
    <div class="card-body text-center py-5">
        <i class="bi bi-clipboard2-data text-secondary" style="font-size:3rem;"></i>
        <h4 class="mt-3">게시판 패키지 설치가 필요합니다</h4>
        <p class="text-muted mb-4">데이터베이스 테이블을 생성해야 게시판 기능을 사용할 수 있습니다.</p>
