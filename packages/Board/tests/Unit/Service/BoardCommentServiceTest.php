...
class BoardCommentServiceTest extends TestCase
{
    ...
    private MemberQueryInterface $memberRepo;
    ...
    protected function setUp(): void
    {
        ...
        $this->memberRepo  = $this->createMock(MemberQueryInterface::class);
    ...
    {
        $this->prepareReadableCommentTarget();
        $member = new MemberProfile(42, 1, 'member42', '회원42', 1, true);
        $this->memberRepo->method('findProfile')->with(42)->willReturn($member);
