...
JOIN (
SELECT 'clothing' c,'material' field_code,'제품 소재' label,10 sort_order UNION ALL SELECT 'clothing','color','색상',20 UNION ALL SELECT 'clothing','size','치수',30 UNION ALL SELECT 'clothing','manufacturer','제조자/수입자',40 UNION ALL SELECT 'clothing','country','제조국',50 UNION ALL SELECT 'clothing','care','세탁방법 및 취급 시 주의사항',60 UNION ALL SELECT 'clothing','manufactured','제조연월',70 UNION ALL SELECT 'clothing','warranty','품질보증기준',80 UNION ALL SELECT 'clothing','service','A/S 책임자와 전화번호',90 UNION ALL
SELECT 'shoes','material','제품 주소재',10 UNION ALL SELECT 'shoes','color','색상',20 UNION ALL SELECT 'shoes','size','치수',30 UNION ALL SELECT 'shoes','manufacturer','제조자/수입자',40 UNION ALL SELECT 'shoes','country','제조국',50 UNION ALL SELECT 'shoes','care','취급 시 주의사항',60 UNION ALL SELECT 'shoes','warranty','품질보증기준',70 UNION ALL SELECT 'shoes','service','A/S 책임자와 전화번호',80 UNION ALL
SELECT 'bag','item_type','종류',10 UNION ALL SELECT 'bag','material','소재',20 UNION ALL SELECT 'bag','color','색상',30 UNION ALL SELECT 'bag','size','크기',40 UNION ALL SELECT 'bag','manufacturer','제조자/수입자',50 UNION ALL SELECT 'bag','country','제조국',60 UNION ALL SELECT 'bag','care','취급 시 주의사항',70 UNION ALL SELECT 'bag','warranty','품질보증기준',80 UNION ALL SELECT 'bag','service','A/S 책임자와 전화번호',90 UNION ALL
SELECT 'fashion_accessory','item_type','종류',10 UNION ALL SELECT 'fashion_accessory','material','소재',20 UNION ALL SELECT 'fashion_accessory','size','치수',30 UNION ALL SELECT 'fashion_accessory','manufacturer','제조자/수입자',40 UNION ALL SELECT 'fashion_accessory','country','제조국',50 UNION ALL SELECT 'fashion_accessory','care','취급 시 주의사항',60 UNION ALL SELECT 'fashion_accessory','warranty','품질보증기준',70 UNION ALL SELECT 'fashion_accessory','service','A/S 책임자와 전화번호',80 UNION ALL
SELECT 'bedding','material','제품 소재',10 UNION ALL SELECT 'bedding','color','색상',20 UNION ALL SELECT 'bedding','size','치수',30 UNION ALL SELECT 'bedding','components','제품 구성',40 UNION ALL SELECT 'bedding','manufacturer','제조자/수입자',50 UNION ALL SELECT 'bedding','country','제조국',60 UNION ALL SELECT 'bedding','care','세탁방법 및 취급 시 주의사항',70 UNION ALL SELECT 'bedding','warranty','품질보증기준',80 UNION ALL SELECT 'bedding','service','A/S 책임자와 전화번호',90 UNION ALL
SELECT 'furniture','name_model','품명 및 모델명',10 UNION ALL SELECT 'furniture','kc','KC 인증정보',20 UNION ALL SELECT 'furniture','size','크기',30 UNION ALL SELECT 'furniture','color','색상',40 UNION ALL SELECT 'furniture','material','재질',50 UNION ALL SELECT 'furniture','components','구성품',60 UNION ALL SELECT 'furniture','manufacturer','제조자/수입자',70 UNION ALL SELECT 'furniture','country','제조국',80 UNION ALL SELECT 'furniture','install','배송·설치 비용',90 UNION ALL SELECT 'furniture','warranty','품질보증기준',100 UNION ALL SELECT 'furniture','service','A/S 책임자와 전화번호',110 UNION ALL SELECT 'furniture','refurbished','재공급(리퍼브) 가구의 재공급 사유 및 하자 부위',120 UNION ALL
...
SELECT 'other_service','provider','서비스 제공 사업자',10 UNION ALL SELECT 'other_service','license','법에 의한 인증·허가 사항',20 UNION ALL SELECT 'other_service','conditions','이용조건',30 UNION ALL SELECT 'other_service','cancel','취소·중도해약·해지 조건 및 환불기준',40 UNION ALL SELECT 'other_service','refund','취소·환불방법',50 UNION ALL SELECT 'other_service','service','소비자 상담 관련 전화번호',60 UNION ALL
SELECT 'other_goods','name_model','품명 및 모델명',10 UNION ALL SELECT 'other_goods','license','법에 의한 인증·허가 사항',20 UNION ALL SELECT 'other_goods','country','제조국 또는 원산지',30 UNION ALL SELECT 'other_goods','manufacturer','제조자/수입자',40 UNION ALL SELECT 'other_goods','service','A/S 책임자와 전화번호',50
