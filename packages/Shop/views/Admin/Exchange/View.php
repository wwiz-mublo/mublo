...
(function(){
 ...
 document.querySelectorAll('.js-inspect').forEach(b=>b.addEventListener('click',()=>{const r=prompt('검수 메모 (선택)')??'';send({action:b.dataset.action,inspection_result:document.getElementById('inspectionResult').value,reason:r});}));
