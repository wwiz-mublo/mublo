...
{
    public function __construct(private MenuManagementInterface $menuManagement)
    {
    }
    ...
    public function onUpdated(CategoryUpdatedEvent $event): void
    {
        ...
        $items = $this->menuManagement->findMenusByUrlPrefix($event->getDomainId(), CategoryUrl::MENU_PREFIX);
