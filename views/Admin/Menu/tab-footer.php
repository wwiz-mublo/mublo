<?php
/**
 * Admin Menu - Tab 4: 푸터 메뉴
 *
 * Index.php에서 include되어 실행됨.
 * Index.php의 모든 PHP 변수에 접근 가능.
 *
 * @var array $footerMenus 푸터 메뉴 (현재 활성)
...
<div class="card">
    <div class="card-hero">
        <i class="bi bi-layout-text-sidebar text-pastel-green"></i>
        <span>푸터 메뉴</span>
        <button type="button" class="btn btn-primary btn-sm ms-auto" id="btn-save-footer">
        ...
        <div class="row g-0">
            ...
            <div class="col-md-5 p-3 border-end" style="overflow-y:auto; max-height:calc(100vh - 340px);">
                ...
                <div id="footer-pool">
                    ...
                    <?php $avail = array_filter($pItems, fn($i) => !$i['show_in_footer']); ?>
                    <?php if (!empty($avail)): ?>
                    ...
                    <?php $hasAny = false; foreach ($allActiveItems as $_i) { if (!$_i['show_in_footer']) { $hasAny = true; break; } } ?>
                    <?php if (!$hasAny): ?>
            ...
            <div class="col-md-7 p-3">
                ...
                <div id="footer-list" style="min-height:48px; background:var(--bs-secondary-bg); border-radius:6px; padding:6px;">
                    <p class="menu-empty-msg text-muted text-center py-4 small mb-0<?= empty($footerMenus) ? '' : ' d-none' ?>">여기에 메뉴를 드래그하세요</p>
