 ...
 */
$pending = $pending ?? [];
$pageTitle = $pageTitle ?? ($title ?? 'FAQ 플러그인 설치');
?>
...
<div class="card">
    <div class="card-body text-center py-5">
        ...
        <h4 class="mt-3">FAQ 플러그인 설치가 필요합니다</h4>
        <p class="text-muted mb-4">데이터베이스 테이블을 생성해야 FAQ 기능을 사용할 수 있습니다.</p>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    btn.addEventListener('click', function () {
        ...
        MubloRequest.requestJson('/admin/faq/install', {}, { loading: true })
            .then(function () {
                location.reload();
            })
            .catch(function (err) {
